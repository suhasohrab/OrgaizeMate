  ...
  return (
    <div id="calendar_container">
      <div id="calendar_header">
        <IconButton className="calendar-btn" onClick={() => updateDate("left")}>
          <NavigateBeforeIcon />
        </IconButton>
        <h5>{showDateInfo}</h5>
        <IconButton className="calendar-btn" onClick={() => updateDate("right")}>
          <NavigateNextIcon />
        </IconButton>
      </div>
      ...
      <Box className="days_index_container">{boxes}</Box>
    </div>
  );
}
