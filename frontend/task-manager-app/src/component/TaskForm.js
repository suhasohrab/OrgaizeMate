        ...
        <div id="infos_form_container">
          ...
          <div id="inputs_form_container">
            <div className="input_con">
              <Typography style={{ fontFamily: 'Hedvig Letter Serif' , fontSize:"20px", position: "relative", top:"-9px"}} sx={{ color: "#C8A2C8" }}>Task name</Typography>
              <TextField
                type="text"
            ...
            <div className="date_picker" >
              <div id="date_displayer" style={{position:"relative", top:"65px"}} >
                {date}{" "}
                <div id="calendar_icon_con">
<CalendarMonthIcon/>                </div>
              </div>
              <div id="time_input" style={{position:"relative", top:"65px"}}>
...
<AccessTimeIcon/>     </div>
            ...
            <div className="input_con desc_con">
              <Typography style={{ fontFamily: 'Hedvig Letter Serif' , fontSize:"20px"}} sx={{ color: "#C8A2C8", position: "relative", top:"38px" }}>Description</Typography>
              <textarea style={{  fontSize:"20px", color:"black"}} ref={descriptionInput} cols={20} rows={10}></textarea>
            </div>
            <div className="upload_send_container">
              ...
              <Button
                id="upload"
                onClick={sendData} style={{ fontFamily: 'Hedvig Letter Serif' , fontSize:"15px"}} 
                sx={{ height: "40px", display: "flex", position: "relative", left:"160px",top:"30px" }}
              >
                Create Task{" "}
              </Button>
            </div>
